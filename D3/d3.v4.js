...
(function (global, factory) {
  ...
  function center(scale) {
    ...
    if (scale.tickAlign) offset = offset * scale.tickAlign();
    return function (d) {
  ...
  function axis(orient, scale) {
    ...
    function axis(context) {
      var values = tickValues == null ? (scale.ticks ? scale.ticks.apply(scale, tickArguments) : scale.domain()) : tickValues,
        ...
        position = (scale.bandwidth ? center : number$1)(scale.copy()),//这里需要追加一个配置 现在是只要有bandwidth方法 都默认tick 显示在中间
  ...
  function band() {
    var scale = ordinal().unknown(undefined),
      ...
      range$$1 = [0, 1],
      step,
      tickAlign = 1, //新增的方法 用来设置序数比例尺 tick刻度的位置 0左对齐 1居中对齐 2 右对齐
      bandwidth,
      round = false,
      paddingInner = 0,
      paddingOuter = 0,
    ...
    //这是扩展的方法 指定tick的对齐方式
    scale.tickAlign = function(_){
      return arguments.length ? (tickAlign = _, rescale()) : tickAlign;
    };
